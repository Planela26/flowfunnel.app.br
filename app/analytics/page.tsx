    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6 flex items-center gap-2.5">
              <span className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-green-500/10 text-green-600 dark:text-green-400 flex-shrink-0">
                <BarChart3 className="w-4 h-4" />
              </span>
              Investimento vs Receita por Plataforma
            </h2>
            <ComparisonChart
              title=""
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Facebook Ads */}
          <div className="bg-white dark:bg-gray-800 border-t-2 border-t-blue-500 rounded-lg shadow-sm p-6 hover:shadow-lg hover:-translate-y-1.5 motion-reduce:hover:translate-y-0 transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                  <div className="bg-gradient-to-r from-blue-600 to-blue-400 h-2 rounded-full transition-all duration-500" style={{ width: `${Math.min(metrics.facebook.ctr * 10, 100)}%` }}></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-1">
          ...
          {/* WhatsApp */}
          <div className="bg-white dark:bg-gray-800 border-t-2 border-t-green-500 rounded-lg shadow-sm p-6 hover:shadow-lg hover:-translate-y-1.5 motion-reduce:hover:translate-y-0 transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
            <div className="flex items-center gap-3 mb-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                  <div className="bg-gradient-to-r from-green-600 to-green-400 h-2 rounded-full transition-all duration-500" style={{ width: `${metrics.whatsapp.responseRate}%` }}></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-1">
          ...
          {/* Hotmart */}
          <div className="bg-white dark:bg-gray-800 border-t-2 border-t-orange-500 rounded-lg shadow-sm p-6 hover:shadow-lg hover:-translate-y-1.5 motion-reduce:hover:translate-y-0 transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
            <div className="flex items-center gap-3 mb-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                  <div className="bg-gradient-to-r from-orange-600 to-orange-400 h-2 rounded-full transition-all duration-500" style={{ width: `${Math.min(metrics.hotmart.conversionRate * 10, 100)}%` }}></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-1">
        ...
        <div className="mt-8 flex gap-4 justify-center">
          <button className="flex items-center gap-2 px-6 py-3 bg-blue-600 dark:bg-blue-500 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors">
            <Download className="w-4 h-4" /> Exportar Relatório
          </button>
          <button className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
            <Mail className="w-4 h-4" /> Agendar Relatório
          </button>
        </div>
      </div>
    </div>
